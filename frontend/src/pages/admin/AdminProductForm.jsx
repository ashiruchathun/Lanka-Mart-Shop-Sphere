...
export default function AdminProductForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-5 sm:p-8 lg:p-10 bg-white rounded-2xl shadow-sm border border-slate-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-[#f8faf8] p-5 sm:p-6 rounded-xl border border-gray-200 space-y-6">
        ...
        <div className="bg-[#f8faf8] p-5 sm:p-6 rounded-xl border border-gray-200 space-y-6">
          ...
          <div>
            ...
            <input type="text" id="image_url" name="image_url" value={formData.image_url} onChange={handleChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 shadow-sm" placeholder="https://example.com/image.jpg or /uploads/product.jpg" />
          </div>
