...
// Admin Products
export const getProducts = () => axios.get(`${API_BASE}/products`).then(res => res.data);
export const getProductById = (id) => axios.get(`${API_BASE}/products/${id}`).then(res => res.data);
export const createProduct = (data) => axios.post(`${API_BASE}/products`, data).then(res => res.data);
export const updateProduct = (id, data) => axios.put(`${API_BASE}/products/${id}`, data).then(res => res.data);
export const deactivateProduct = (id) => axios.delete(`${API_BASE}/products/${id}`).then(res => res.data);
